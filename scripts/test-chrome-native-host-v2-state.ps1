...
function Copy-JsonValue {
  ...
  return (ConvertFrom-ChromeNativeHostV2Json ($Value | ConvertTo-Json -Depth 30))
}
...
try {
  ...
  $brokenDocument = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  ...
  $stringNumberDocument = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  ...
  Update-ChromeNativeHostV2State $chromeRoot $runtimeInventory $script:CodexHome
  Test-ChromeNativeHostV2State $chromeRoot $runtimeInventory $script:CodexHome
  $repairedNumberDocument = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  $repairedNumberEntry = @($repairedNumberDocument.entries |
  ...
  $missingUpdatedDocument = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  ...
  Update-ChromeNativeHostV2State $chromeRoot $runtimeInventory $script:CodexHome
  Test-ChromeNativeHostV2State $chromeRoot $runtimeInventory $script:CodexHome
  $repairedUpdatedDocument = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  $repairedUpdatedEntry = @($repairedUpdatedDocument.entries |
    Where-Object { $_.entryId -ceq $expected.entryId } | Select-Object -First 1)[0]
  ...
  $badPresenceDocument = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  ...
  Update-ChromeNativeHostV2State $chromeRoot $runtimeInventory $script:CodexHome
  Test-ChromeNativeHostV2State $chromeRoot $runtimeInventory $script:CodexHome
  $repairedPresenceDocument = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  $repairedPresenceEntry = @($repairedPresenceDocument.entries |
    Where-Object { $_.entryId -ceq $expected.entryId } | Select-Object -First 1)[0]
  ...
  $stringTopLevelSchema = ConvertFrom-ChromeNativeHostV2Json (Get-Content -Raw -Encoding UTF8 -LiteralPath $brokenStatePath)
  ...
  Write-Output 'Chrome native-host v2 state regression passed'
} finally {
